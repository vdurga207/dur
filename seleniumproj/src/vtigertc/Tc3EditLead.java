...
System.setProperty("webdriver.chrome.driver","D:\\selenium_durga\\browser drivers\\chromedriver.exe");
		...
		//click on massedit
		WebElement massedit=x.findElement(By.xpath("//*[@id=\"massdelete\"]/table/tbody/tr[1]/td/table[2]/tbody/tr/td/input[2]"));
		massedit.click();
...
massedit.click();
//verify massedit field
if(wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//*[@id='massedit']/table/tbody/tr/td[1]"),"Mass Edit - Records Fields")))	
{
	System.out.println("Mass Edit - Records Fields is verified");
}
else
{
	System.out.println("fail to verify massedit");
}

Thread.sleep(2000);
//click on cancel
x.findElement(By.xpath("//input[@value='  Cancel  ']")).click();;
//click on edit in Action bar
x.findElement(By.xpath("html/body/table[4]/tbody/tr/td[2]/div[4]/form/table/tbody/tr[1]/td/div/table/tbody/tr[3]/td[10]/a[1]")).click();
//verify editing field
String oldlead=x.findElement(By.xpath("/html/body/table[4]/tbody/tr/td[2]/div/span/font")).getTagName();
System.out.println(oldlead);
WebElement lastnam=x.findElement(By.name("lastname"));
lastnam.clear();
lastnam.sendKeys("hidddd");
//click on save
x.findElement(By.xpath("/html/body/table[4]/tbody/tr/td[2]/div/form/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody/tr[1]/td/div/input[1]")).click();
//search for
x.findElement(By.className("txtBox")).sendKeys(id);
//click on serachnow
x.findElement(By.name("submit")).click();
String name=x.findElement(By.xpath("html/body/table[4]/tbody/tr/td[2]/div[4]/form/table/tbody/tr[1]/td/div/table/tbody/tr[3]/td[3]")).getText();
